...
const Alam = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await instance.get("/agrotourism/activity/alam");
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: "url('/images/alam.jpg')",
        }}
      >
        ...
        <h1 className="relative text-white font-bold text-xl text-left mr-auto mt-10 md:mt-0 md:mr-0 md:text-4xl md:text-center">
          Pesan Aktivitas Wisata <br />
          <span className=" md:text-4xl text-xl">Alam</span>
        </h1>
