  ...
  return (
    <nav
      className={`fixed w-full mr-7 top-0 md:px-7 py-0.5 sm:py-1 transition-colors duration-300 ${
        scrolling ? "shadow-lg bg-white text-black" : "shadow-md text-black"
      } z-50`}
    >
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ...
                        : "text-hitam py-2 px-3 font-medium md:text-sm lg:text-base hover:font-bold duration-300  "
                    }
                  >
                    Dashboard
                  </NavLink>
